...
?>
	...
	<div class="container mt-5 px-5">
		...
		<div class="row">
			<?php 
		$sql="SELECT * FROM categories ORDER BY rand() ASC limit 8";
			...
			<div class="col-12">
				<div class="MultiCarousel" data-items="1,3,5,6" data-slide="1" id="MultiCarousel"  data-interval="1000">
		            <div class="MultiCarousel-inner">
		            	<?php 
		$sql="SELECT * FROM items WHERE discount !='' ORDER BY rand() ASC limit 8";
							$stmt=$conn->prepare($sql);
							$stmt->execute();
							$items=$stmt->fetchAll();
		                ...
		                <div class="item">
		                    <div class="pad15">
		                        ...
		                        <p class="item-price">
		                        	...
		                        	<span class="d-block"><?= $dprice-$ddiscount; ?> Ks</span>
		                        	<?php else: ?>
		                        	<span class="d-block"><?= $dprice; ?> Ks</span>
		                        </p>
		                    <?php endif ?>
